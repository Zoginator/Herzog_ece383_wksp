...
module design_1 (
  ...
  (* X_INTERFACE_IGNORE = "true" *)
  output pulse;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.PS2_CLK CLK" *)
  (* X_INTERFACE_MODE = "slave CLK.PS2_CLK" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.PS2_CLK, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, INSERT_VIP 0" *)
  inout ps2_clk;
  (* X_INTERFACE_IGNORE = "true" *)
  inout ps2_data;
  (* X_INTERFACE_IGNORE = "true" *)
