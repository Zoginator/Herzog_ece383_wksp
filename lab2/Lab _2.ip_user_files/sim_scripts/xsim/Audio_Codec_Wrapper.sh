...
#
# Script generated by Vivado on Tue Feb 10 08:05:16 -0700 2026
# SW Build 5239630 on Fri Nov 08 22:35:27 MST 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : Audio_Codec_Wrapper.sh
...
#
# Usage        : Audio_Codec_Wrapper.sh
#                Audio_Codec_Wrapper.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                Audio_Codec_Wrapper.sh [-reset_run]
#                Audio_Codec_Wrapper.sh [-reset_log]
#                Audio_Codec_Wrapper.sh [-help]
#
...
# script info
echo -e "Audio_Codec_Wrapper.sh - Script generated by export_simulation (Vivado v2024.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./Audio_Codec_Wrapper.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L xpm -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot Audio_Codec_Wrapper xil_defaultlib.Audio_Codec_Wrapper xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim Audio_Codec_Wrapper -key {Behavioral:sim_1:Functional:Audio_Codec_Wrapper} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb Audio_Codec_Wrapper.wdb xsim.dir libdpi.so)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./Audio_Codec_Wrapper.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: Audio_Codec_Wrapper.sh [-help]\n\
Usage: Audio_Codec_Wrapper.sh [-step]\n\
Usage: Audio_Codec_Wrapper.sh [-lib_map_path]\n\
Usage: Audio_Codec_Wrapper.sh [-reset_run]\n\
Usage: Audio_Codec_Wrapper.sh [-reset_log]\n\
Usage: Audio_Codec_Wrapper.sh [-keep_index]\n\
Usage: Audio_Codec_Wrapper.sh [-noclean_files]\n\n\
