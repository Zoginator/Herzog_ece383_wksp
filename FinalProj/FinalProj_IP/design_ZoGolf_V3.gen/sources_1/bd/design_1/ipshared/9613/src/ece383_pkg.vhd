...
package ece383_pkg is
  ...
  constant BEIGE : color_t := x"fCfCC6";
  constant GRAY : color_t := x"AAAAAA";
  constant SAND : color_t := x"C2B280";
...
-- scoreboard BRAM entities
component legend_BRAM_Pair is
    Port ( clk : in STD_LOGIC;
           reset_n : in STD_LOGIC;
           position : in STD_LOGIC_VECTOR(13 downto 0);
           data_out : out STD_LOGIC_VECTOR(3 downto 0));
...
component score_BRAM_Pair is
  ...
  function detail_to_BRAM_address(coord: coordinate_t) return STD_LOGIC_VECTOR;
...
function detail_to_BRAM_address(coord: coordinate_t) return STD_LOGIC_VECTOR is
    variable col : unsigned(9 downto 0);
    variable row : unsigned(9 downto 0);
    variable mult_res : unsigned(17 downto 0);
    variable final_res : unsigned(17 downto 0);
...
begin
    ...
    row := unsigned(coord.row);
    mult_res := row * to_unsigned(120,8);
    final_res := mult_res + ("0000000000" & col(7 downto 0));
    trunc_res := std_logic_vector(final_res(13 downto 0));
    return trunc_res;
end function;
