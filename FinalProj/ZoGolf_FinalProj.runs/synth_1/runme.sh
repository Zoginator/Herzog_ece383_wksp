...
HD_PWD='C:/Users/C27Soren.Herzog/ece383/Herzog_ece383_wksp/FinalProj/ZoGolf_FinalProj.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ZoGolf_DataPath.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ZoGolf_DataPath.tcl
