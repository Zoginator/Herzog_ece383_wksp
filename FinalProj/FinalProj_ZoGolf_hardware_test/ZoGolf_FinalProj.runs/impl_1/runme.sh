...
HD_PWD='C:/Users/C27Soren.Herzog/ece383/Herzog_ece383_wksp/FinalProj/ZoGolf_FinalProj.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ZoGolf_DataPath.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ZoGolf_DataPath.tcl -notrace
